...
#hostname = "${MACHINE}"
hostname = "Trux-Q01"
Q01_BSP_VERSION = "\r Rootfs Version : TRUX-iMX6UL-Q01-V.1.0.0-YoctoKrogoth\n"
...
do_install_basefilesissue () {
	...
	install -m 644 ${WORKDIR}/issue*  ${D}${sysconfdir}
	        if [ -n "${Q01_BSP_VERSION}" ]; then
                printf "${Q01_BSP_VERSION} " >> ${D}${sysconfdir}/issue
                printf "${Q01_BSP_VERSION} " >> ${D}${sysconfdir}/issue.net
        fi
